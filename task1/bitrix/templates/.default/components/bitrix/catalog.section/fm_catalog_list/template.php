					...
					<td class="description_wrapp">
						<div class="description">
							...
							<div class="preview_text">
                                <?
                                //&lt;br /&gt;
                                /*$text = str_replace("&lt;br /&gt;","|",htmlspecialcharsEx($arItem["DETAIL_TEXT"]));
                                ...
                                <?php
                                $text = '';
                                $arrDT = explode("<br",$arItem["DETAIL_TEXT"]);
                                foreach ($arrDT as $itemDT){
                                    $resDT = str_replace(' />','',$itemDT);
                                    if(strlen(trim($resDT))>0){
                                        if(strlen($text)==0) {
                                            $text = trim($resDT);
                                        }else{
                                            $text = $text .'</br>'. trim($resDT);
                                        }

                                    }
                                }

                                //$text = str_replace('<br','',$arItem["DETAIL_TEXT"]);
                                //$text = str_replace('/>','',$text);
                                ?>
                                <?=$text?>
                            </div>
