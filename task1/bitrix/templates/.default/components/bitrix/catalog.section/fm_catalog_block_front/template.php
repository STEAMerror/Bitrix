...
<?if( count( $arResult["ITEMS"] ) >= 1 ){?>
	...
	<div class="top_wrapper items_wrapper">
		...
		<?foreach($arResult["ITEMS"] as $arItem){?>
			...
			<div class="catalog_item_wrapp col-m-12 col-lg-<?=$col;?> col-md-4 col-sm-<?=floor(12 / round($arParams['LINE_ELEMENT_COUNT'] / 2))?> item item_block <?if($count_for_mobile>=4):?>disable_mobile<?endif;?>" data-col="<?=$col;?>">
